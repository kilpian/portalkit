  ...
  return (
    <div style={{ padding: '32px 32px 64px', maxWidth: 900, margin: '0 auto' }}>
      ...
      <div className="card" style={{ padding: '64px 20px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-dim)', maxWidth: 420, margin: '0 auto 24px', lineHeight: 1.65 }}>
          Send updates, share links, and communicate with your clients directly through their portal.
          Clients access everything through their private link — no account needed.
        </p>
