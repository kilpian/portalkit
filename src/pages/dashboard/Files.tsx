  ...
  return (
    <div style={{ padding: '32px 32px 64px', maxWidth: 800, margin: '0 auto' }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--text-muted)' }}>Share photos and documents with your clients.</p>
      </div>
      ...
      <div className="card" style={{ padding: '48px 32px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-dim)', maxWidth: 360, margin: '0 auto', lineHeight: 1.6 }}>
          Upload galleries, contracts, and other files directly to each client's portal for easy access.
        </p>
      </div>
    </div>
  )
