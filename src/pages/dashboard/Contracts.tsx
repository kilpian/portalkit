      ...
      <body>
        ...
        <div class="sig-grid">
          <div class="sig-block">
            ...
            <div style="font-family: 'Dancing Script', cursive; font-size: 28px; color: #1B4332; border-bottom: 1px solid #333; padding-bottom: 4px; margin-bottom: 4px;">${c.photographer_signature || businessName}</div>
            <div style="font-size: 11px; color: #666;">${businessName}${photographerFullName ? ' · ' + photographerFullName : ''}</div>
          ...
          <div class="sig-block">
            ...
            <div style="font-family: 'Dancing Script', cursive; font-size: 28px; color: #1B4332; border-bottom: 1px solid #333; padding-bottom: 4px; margin-bottom: 4px; min-width: 200px;">${c.signed_by_name ?? '—'}</div>
            <div style="font-size: 11px; color: #666;">Electronic signature${clientDate ? ' · ' + clientDate : ''}${c.content_hash ? ' · Ref: ' + c.content_hash.slice(-8).toUpperCase() : ''}</div>
          </div>
        </div>
